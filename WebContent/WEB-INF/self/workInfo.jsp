...
<link rel="stylesheet" href="${pageContext.request.contextPath }/css/workInfo.css" type="text/css" />
...
<body>
	...
	<div class="modifyInfo">
		<div class="choice">
			...
			<div class="modifyWorkInfo">
				<div class="privateSetup">
					你可以通过<a href="#">隐私设置</a>控制谁可以看见以下内容
				</div>
				<div class="workInfoForm">
					<form
						action="${pageContext.request.contextPath }/modify.do?flag=modifyContractInfo"
						method="post">
						<table>
							<tr>
								<td><span class="font3">*职业:</span></td>
								<td><input type="text" name="" value=""/></td>
								<td>可在中文姓名后添加英文名称</td>
							</tr>
							<tr>
								<td><span class="font3">*公司:</span></td>
								<td><input type="text" name="" value=""/></td>
								<td></td>
							</tr>
							<tr>
								<td><span class="font3">*职位:</span></td>
								<td><input type="text" name="" value=""/></td>
								<td></td>
							</tr>
