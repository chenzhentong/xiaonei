...
<html>
<head>
<link rel="stylesheet" href="${pageContext.request.contextPath }/css/onlineFriends.css" type="text/css" />
			...
			<div class="friend_table">
				<table border="1px">
					<tr>
						...
						<td><span class="span1"><a href="${pageContext.request.contextPath }/friend.do?flag=onlineFriends">在线好友</a></span></td>
